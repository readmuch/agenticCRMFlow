...
- **대시보드 탭 뷰** — 고객 대시보드 / 세일즈 노트 전체 조회 / 페르소나 전체 조회 탭 전환 (localStorage 유지)
- **세일즈 노트 전체 조회** — 고객사·날짜 범위·활동 유형·섹터·담당자·텍스트 검색 필터, 컬럼 정렬, 상세 모달
...
- **세일즈 노트 탭** — 전체 고객 노트 통합 조회, 고객사·날짜 범위·활동 유형·섹터·담당자·텍스트 필터, 컬럼 정렬, 상세 모달
